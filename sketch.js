...
function setup(){
  ...
  man.setCollider("rectangle",0,0,500,1200);//-150,0,500,1200
  man.debug = false
    key1=createSprite(330,130,10,10);
    key1.addImage(obj);
    key1.scale=0.03;
    key1.visible=false;
 key2=createSprite(840,600,10,10);//480,585
  key2.addImage(obj);
  key2.scale=0.03;
  key2.visible=false;

  key3=createSprite(640,385,10,10);//480,585
  key3.addImage(obj);
  key3.scale=0.03;
  key3.visible=false;

  key4=createSprite(110,540,10,10);//480,585
  key4.addImage(obj);
  key4.scale=0.03;
  key4.visible=false;
  ...
  key5.scale=0.03;
  key5.visible=false;
  key6=createSprite(5,90,10,10);//480,585
  key6.addImage(obj);
  key6.scale=0.02;
  key6.visible=false;

  key7=createSprite(290,5,10,10);//480,585
  key7.addImage(obj);
  key7.scale=0.02;
  key7.visible=false;
  key8=createSprite(990,650,10,10);//480,585
  key8.addImage(obj);
  key8.scale=0.02;
  key8.visible=false;
  key9=createSprite(995,5,10,10);//480,585
  key9.addImage(obj);
  key9.scale=0.02;
  key9.visible=false;
...
passer_6 =createSprite(510,170,1000,10)//520,265,1,1
  passer_6.visible=true;
  passer_6.shapeColor="blue";
if (man.isTouching(passer_6)){
  background(r3);
